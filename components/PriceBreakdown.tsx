        ...
        <View style={styles.section}>
          <View style={styles.topRow}>
            <Text style={styles.aircraft}>
              {cropTextForDevice(priceBreakdown.aircraftType)}
            </Text>
            {!currentUser.isProjectManager && (
              <Text style={styles.priceListType}>
          ...
          {priceBreakdown.services?.map((service, index) => (
            <View key={index} style={styles.itemRow}>
              <Text style={styles.itemName}>
                {cropTextForDevice(service.name, 40)}
              </Text>
            ...
            <>
              ...
              {priceBreakdown.additionalFees?.length > 0 && (
                <>
                  ...
                  {priceBreakdown.additionalFees.map((fee, index) => (
                    <View key={index} style={styles.itemRow}>
                      <Text style={styles.itemName}>
              ...
              <View style={styles.totalRowBottom}>
                ...
                <Text style={[styles.totalValue, { fontWeight: "500" }]}>
